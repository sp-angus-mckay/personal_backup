...
campaign_start  <- '2016-04-28 00:00:00' # will analyse in 24 hour periods after this time (and hour and 6-hour periods)
analysis_period <- 7 # in days
cost_of_campaign <- 3000
...
benchmark2_start_date <- '2016-03-31 00:00:00'
benchmark2_end_date <- '2016-04-28 00:00:00'
# Might need to add some sort of other option for comparing to previous christmas or something?
...
colnames(NGU_table) <- c("day_start", "day_end", "weekday", "NGU_actual", "NGU_benchmark(other_countries)", "uplift(cf_other_countries)",
                         "NGU_benchmark(earlier_period)", "uplift(cf_earlier_period)", "marketing tracked NGU")
