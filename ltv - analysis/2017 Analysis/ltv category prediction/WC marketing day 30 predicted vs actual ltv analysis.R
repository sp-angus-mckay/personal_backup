### World Chef actual vs day 30 predicted ltv
rm(list=ls())
...
ltvs_organic_android_30day_noCat0$actual_category <-
  as.integer(cut(ltvs_organic_android_30day_noCat0$ltv_actual, c(-1,0,10,50,200,600,999999), labels = 0:5))-1
...
ltvs_organic_ios_30day_noCat0$actual_category <-
  as.integer(cut(ltvs_organic_ios_30day_noCat0$ltv_actual, c(-1,0,10,50,200,600,999999), labels = 0:5))-1
...
ltvs_marketing_android_30day_noCat0$actual_category <-
  as.integer(cut(ltvs_marketing_android_30day_noCat0$ltv_actual, c(-1,0,10,50,200,600,999999), labels = 0:5))-1
...
ltvs_marketing_ios_30day_noCat0$actual_category <-
  as.integer(cut(ltvs_marketing_ios_30day_noCat0$ltv_actual, c(-1,0,10,50,200,600,999999), labels = 0:5))-1
