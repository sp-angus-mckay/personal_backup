### Monster Legends RPI prediction based RPI curve from past data
rm(list=ls())
...
# register source = applifier, adcolony, google adwords, resultsmedia, vungle
# platform = android, ios
# country = US, DE, BR, FR, MX
...
### FR
applifier_android_FR <- extrapolation_model('applifier', 'android', 'FR', 1:180)
applifier_ios_FR <- extrapolation_model('applifier', 'ios', 'FR', 1:180)
...
resultsmedia_android_FR <- extrapolation_model('resultsmedia', 'android', 'FR', 1:180)
resultsmedia_ios_FR <- extrapolation_model('resultsmedia', 'ios', 'FR', 1:180)
...
output_FR <- as.data.frame(rbind("applifier-android" = applifier_android_FR,
                                 "applifier-ios" = applifier_ios_FR,
                                 ...
                                 "res med-android" = resultsmedia_android_FR,
                                 "res med-ios" = resultsmedia_ios_FR,
