### Monster City actual vs day 7 predicted ltv
rm(list=ls())
...
pred_date_start = '2016-05-03' # (2016-07-08 ,2016-05-03, 2016-05-24)
...
temp_data <- NULL
for(d in dates) {
  temp_data <- rbind(temp_data, dbGetQuery(spdb, SQL_get_ltv_predictions('applifier', 'android', 'US', d)))
}
