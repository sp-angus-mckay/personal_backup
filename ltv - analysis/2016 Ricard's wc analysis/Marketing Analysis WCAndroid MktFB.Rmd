...
###- All Facebook Marketing related data only.
...
# WORLD CHEF ANDROID US
## WC - ANDROID - US - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_US_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
             nvl (sum(revenues_dollars_net) / count(distinct user_id),0) as rpi
      from restaurantcity.t_user
      where date_register_android is not null
      and   date_register_android >= '2016-01-14'
      and   migrate_date_orphaned is null
      and   register_source_type = 'marketing'
      and   register_ip_country = 'US'
      and   LOWER (register_source) like '%facebook%'
      group by d_date
...
### CHART
```{r, echo=FALSE}
data_wc_android_US_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_US_marketing_not_fb);
Data <- data_wc_android_US_marketing_not_fb;
...
# WORLD CHEF ANDROID GB
## WC - ANDROID - GB - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_GB_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
...
### CHART
```{r, echo=FALSE}
data_wc_android_GB_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_GB_marketing_not_fb);
Data <- data_wc_android_GB_marketing_not_fb;
...
# WORLD CHEF ANDROID CA
## WC - ANDROID - CA - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_CA_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
...
### CHART
```{r, echo=FALSE}
data_wc_android_CA_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_CA_marketing_not_fb);
Data <- data_wc_android_CA_marketing_not_fb;
...
# WORLD CHEF ANDROID AU
## WC - ANDROID - AU - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_AU_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
...
### CHART
```{r, echo=FALSE}
data_wc_android_AU_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_AU_marketing_not_fb);
Data <- data_wc_android_AU_marketing_not_fb;
...
# WORLD CHEF ANDROID FR
## WC - ANDROID - FR - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_FR_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
...
### CHART
```{r, echo=FALSE}
data_wc_android_FR_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_FR_marketing_not_fb);
Data <- data_wc_android_FR_marketing_not_fb;
...
# WORLD CHEF ANDROID DE
## WC - ANDROID - DE - Marketing ONLY Facebook

### SQL CODE
```{r, echo=TRUE}
sql_wc_android_DE_marketing_not_fb = "
       select d_cohort,
       rpi
from (select rank() over (order by date (date_register_android) desc) d_cohort,
             date (date_register_android) d_date,
...
### CHART
```{r, echo=FALSE}
data_wc_android_DE_marketing_not_fb <- dbGetQuery(spdb,sql_wc_android_DE_marketing_not_fb);
Data <- data_wc_android_DE_marketing_not_fb;
