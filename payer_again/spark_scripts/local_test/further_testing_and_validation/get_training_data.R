...
for(i in 1:length(training_dates)) {
  payer_again_data <- rbind(payer_again_data, dbGetQuery(spdb, query1(training_dates[[i]], training_dates_minus_2[[i]], training_dates_minus_7[[i]])))
...
test_date1 <- '2016-08-01'
test_date2 <- '2016-09-01'
test_date3 <- '2016-12-15'

payer_again_test_date1 <- dbGetQuery(spdb, query1(test_date1 , date(as.POSIXct(test_date1) - days(2)), date(as.POSIXct(test_date1) - days(7))))
payer_again_test_date2 <- dbGetQuery(spdb, query1(test_date2 , date(as.POSIXct(test_date2) - days(2)), date(as.POSIXct(test_date2) - days(7))))
payer_again_test_date3 <- dbGetQuery(spdb, query1(test_date3 , date(as.POSIXct(test_date3) - days(2)), date(as.POSIXct(test_date3) - days(7))))

payer_again_test_date1 <- na.omit(payer_again_test_date1)
payer_again_test_date2 <- na.omit(payer_again_test_date2)
payer_again_test_date3 <- na.omit(payer_again_test_date3)
...
saveRDS(payer_again_data, file=paste0("~/Desktop/sp-analytics-machine-learning-develop-master/payer_again/spark_scripts/local_test/further_testing/data/training_data",training_dates[[1]],".rds"))
saveRDS(payer_again_test_date1, file=paste0("~/Desktop/sp-analytics-machine-learning-develop-master/payer_again/spark_scripts/local_test/further_testing/data/test_data",test_date1,".rds"))
saveRDS(payer_again_test_date2, file=paste0("~/Desktop/sp-analytics-machine-learning-develop-master/payer_again/spark_scripts/local_test/further_testing/data/test_data",test_date2,".rds"))
saveRDS(payer_again_test_date3, file=paste0("~/Desktop/sp-analytics-machine-learning-develop-master/payer_again/spark_scripts/local_test/further_testing/data/test_data",test_date3,".rds"))
