...
payer_again_data_train <- createDataFrame(payer_again_data[payer_again_data$days_since_register>1 & payer_again_data$days_since_transaction<=7,])
payer_again_data_test1 <- createDataFrame(payer_again_test_date1[payer_again_test_date1$days_since_register>1 & payer_again_test_date1$days_since_transaction<=7,])
payer_again_data_test2 <- createDataFrame(payer_again_test_date2[payer_again_test_date2$days_since_register>1 & payer_again_test_date2$days_since_transaction<=7,])
payer_again_data_test3 <- createDataFrame(payer_again_test_date3[payer_again_test_date3$days_since_register>1 & payer_again_test_date3$days_since_transaction<=7,])
...
pred1_gbt <- predict(gbt_model_payers_last_7_days, payer_again_data_test1)
pred2_gbt <- predict(gbt_model_payers_last_7_days, payer_again_data_test2)
pred3_gbt <- predict(gbt_model_payers_last_7_days, payer_again_data_test3)
...
no_users_days_since_transaction <- sapply(0:7, function(t) {
...
write.ml(object = gbt_model_payers_last_7_days, path = paste0("model/gbt_model_payers_last_7_days"), overwrite=TRUE)
