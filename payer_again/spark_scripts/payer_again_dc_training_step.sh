...
#sudo R --vanilla --slave -f /home/amckay/payer_again_dc/production/src/payer_again_dc_training.R
sudo Rscript /home/amckay/payer_again_dc/production/src/payer_again_dc_training.R
